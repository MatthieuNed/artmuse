...
function Milestones() {
  ...
  const milestone = [
    ...
    {image: milestone3, data: "Recommendation", amount: "265"}
  ]
    ...
    <div className="milestones">
      {
        milestone.map(({image,data,amount}) => {
          return (
            <motion.div className="milestone" variants={milestoneAnimations} animate={controls} transition={{delay:0.03,type:"tween",duration:0.8}}>
              <p>{amount}</p>
              <span>{data}</span>
